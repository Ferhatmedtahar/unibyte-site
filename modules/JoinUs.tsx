        ...
        >
          ...
          <div className="relative isolate overflow-hidden px-4 py-12 sm:px-24">
            ...
            >
              ...
              >
                <svg className="h-7 w-7 text-red-500 hover:text-red-400 transition-colors duration-200" viewBox="0 0 24 24" fill="currentColor">
              ...
              >
                <svg className="h-7 w-7 text-blue-500 hover:text-blue-400 transition-colors duration-200" viewBox="0 0 24 24" fill="currentColor">
              ...
              >
                <svg className="h-7 w-7 text-pink-500 hover:text-pink-400 transition-colors duration-200" viewBox="0 0 24 24" fill="currentColor">
