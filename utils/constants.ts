...
export const teamMembers = [
  ...
  { name: "Azzouzi Israa", role: "Deputy General Secretary" },
  { name: "Hadibi Ramy", role: "Equipment and Supplies Officer" },
  { name: "Elaguab Faouzi Saber", role: "Design & Social Media Manager" },
